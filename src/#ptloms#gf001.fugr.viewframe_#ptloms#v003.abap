*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/PTLOMS/V003
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/PTLOMS/V003        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/PTLOMS/V003'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /PTLOMS/V003_EXTRACT
TOTAL = /PTLOMS/V003_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/PTLOMS/V003'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/PTLOMS/V003-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /PTLOMS/V003_EXTRACT
TOTAL = /PTLOMS/V003_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/PTLOMS/V003-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/PTLOMS/V003'
...
TOTAL = /PTLOMS/V003_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/PTLOMS/V003-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/PTLOMS/V003-UPD_FLAG NE SPACE.
