*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/PTLOMS/V011
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/PTLOMS/V011        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/PTLOMS/V011'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /PTLOMS/V011_EXTRACT
TOTAL = /PTLOMS/V011_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/PTLOMS/V011'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/PTLOMS/V011-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /PTLOMS/V011_EXTRACT
TOTAL = /PTLOMS/V011_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/PTLOMS/V011-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/PTLOMS/V011'
...
TOTAL = /PTLOMS/V011_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/PTLOMS/V011-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/PTLOMS/V011-UPD_FLAG NE SPACE.
