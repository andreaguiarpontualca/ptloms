*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/PTLOMS/V015
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/PTLOMS/V015        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/PTLOMS/V015'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /PTLOMS/V015_EXTRACT
TOTAL = /PTLOMS/V015_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/PTLOMS/V015'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/PTLOMS/V015-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /PTLOMS/V015_EXTRACT
TOTAL = /PTLOMS/V015_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/PTLOMS/V015-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/PTLOMS/V015'
...
TOTAL = /PTLOMS/V015_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/PTLOMS/V015-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/PTLOMS/V015-UPD_FLAG NE SPACE.
