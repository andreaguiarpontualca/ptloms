*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/PTLOMS/V016
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/PTLOMS/V016        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/PTLOMS/V016'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /PTLOMS/V016_EXTRACT
TOTAL = /PTLOMS/V016_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/PTLOMS/V016'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/PTLOMS/V016-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /PTLOMS/V016_EXTRACT
TOTAL = /PTLOMS/V016_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/PTLOMS/V016-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/PTLOMS/V016'
...
TOTAL = /PTLOMS/V016_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/PTLOMS/V016-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/PTLOMS/V016-UPD_FLAG NE SPACE.
