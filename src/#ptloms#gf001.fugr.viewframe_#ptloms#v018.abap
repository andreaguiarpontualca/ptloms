*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/PTLOMS/V018
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/PTLOMS/V018        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/PTLOMS/V018'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /PTLOMS/V018_EXTRACT
TOTAL = /PTLOMS/V018_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/PTLOMS/V018'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/PTLOMS/V018-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /PTLOMS/V018_EXTRACT
TOTAL = /PTLOMS/V018_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/PTLOMS/V018-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/PTLOMS/V018'
...
TOTAL = /PTLOMS/V018_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/PTLOMS/V018-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/PTLOMS/V018-UPD_FLAG NE SPACE.
