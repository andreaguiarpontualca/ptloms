...
*                 <lfsw_total>.
*
*  DATA: lwa_row        TYPE /ptloms/tb071.
*  DATA: lv_msg         TYPE c LENGTH 255.
*
*  SELECT *
*    FROM /ptloms/tb071
*    INTO TABLE @DATA(lt_tb071).
*
*  LOOP AT total.
*
*    CLEAR:
...
FORM f_upd_user_date_time.
  ...
  /ptloms/tb071-ernam = sy-uname.
  /ptloms/tb071-erdat = sy-datum.
  /ptloms/tb071-erzeit = sy-uzeit.

  /ptloms/tb071-aenam = sy-uname.
  /ptloms/tb071-aedat = sy-datum.
  /ptloms/tb071-aezeit = sy-uzeit.
