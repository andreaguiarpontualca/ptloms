...
TYPES: BEGIN OF ty_ordem,
         ...
         vornr      TYPE vornr,
         status_sis TYPE char40,
       END OF ty_ordem.

* Declaração de tabela interna
DATA: lt_associar       TYPE STANDARD TABLE OF /ptloms/et119,
      wl_associar       TYPE /ptloms/et119,
      lt_selected_nodes TYPE lvc_t_nkey,
      ls_selected_nodes LIKE LINE OF lt_selected_nodes,
      lt_afko           TYPE TABLE OF ty_ordem,
      wl_afko           TYPE ty_ordem.

DATA:
  ok_100 TYPE sy-ucomm,
  ok_101 TYPE sy-ucomm,
  ok_102 TYPE sy-ucomm.
...
DATA: gt_despacho TYPE /ptloms/ct079,
      ls_despacho LIKE LINE OF gt_despacho,
...
DATA: gt_despacho_tree TYPE /ptloms/ct080, "OCCURS 0,      "Output-Table
      ls_despacho_tree LIKE LINE OF  gt_despacho_tree,
      gt_fieldcatalog  TYPE lvc_t_fcat,
      ok_code          LIKE sy-ucomm,
      save_ok          LIKE sy-ucomm.           "OK-Code

DATA: gv_pula           TYPE c LENGTH 4  VALUE 'PULA',
      gv_valida_container type c LENGTH 1 value 'X'.
...
PARAMETERS: p_oper   TYPE c NO-DISPLAY DEFAULT 'X',
            p_ordens TYPE c NO-DISPLAY.
